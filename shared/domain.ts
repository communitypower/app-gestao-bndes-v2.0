...
export const TEAM_SEED: ReadonlyArray<{
  ...
  { name: "Floriano Carlos Martins Pires Jr.", title: "Professor", institution: "UFRJ", email: "floriano@oceanica.ufrj.br", appRole: "coordenador" },
  { name: "Segen Farid Estefen", title: "Professor", institution: "UFRJ", email: "segen@lts.coppe.ufrj.br", appRole: "coordenador" },
  { name: "Luiz Felipe Assis", title: "Professor", institution: "UFRJ", email: "felipe@oceanica.ufrj.br", appRole: "coordenador" },
  { name: "Cassiano Marins de Souza", title: "Consultor", institution: "Consultoria", email: "cassianomarins@gmail.com", appRole: "coordenador" },
  { name: "Carlos Frederico Leão Rocha", title: "Professor", institution: "UFRJ", email: "fred@ie.ufrj.br", appRole: "coordenador" },
  { name: "Marcelo Colomer Ferraro", title: "Professor", institution: "UFRJ", email: "marcelo.colomer@gmail.com", appRole: "coordenador" },
  { name: "Marcos Bernardes Cozzolino do Nascimento", title: "Consultor", institution: "Consultoria", email: "marcoscozzolino@poli.ufrj.br", appRole: "coordenador" },
  { name: "Marcos Pedreira da Silva", title: "Técnico de TI", institution: "UFRJ", email: "marcos.pedreira@ufrj.br", appRole: "coordenador" },
  { name: "Antonio João Prates", title: "Consultor", institution: "AQUAPAR", email: "prates@aquapar.com.br", appRole: "coordenador" },
  { name: "Armando Freigedo Rodrigues Filho", title: "Consultor", institution: "AQUAPAR", email: "freigedo@aquapar.com.br", appRole: "coordenador" },
  { name: "Marcelo Igor Lourenço de Souza", title: "Professor", institution: "UFRJ", email: "migor@lts.coppe.ufrj.br", appRole: "coordenador" },
  { name: "Carlos Daher Padovezi", title: "Pesquisador", institution: "IPT", email: "padnaval@ipt.br", appRole: "coordenador" },
  { name: "Jean David Job Emmanuel Marie Caprace", title: "Professor", institution: "UFRJ", email: "jdcaprace@oceanica.ufrj.br", appRole: "coordenador" },
  { name: "Andre Ricardo Mendonça Pinheiro", title: "Doutorando", institution: "UFRJ", email: "andrericardopinheiro@gmail.com", appRole: "coordenador" },
  { name: "Marta Cecilia Tapia Reyes", title: "Professor", institution: "UFRJ", email: "martatapia@poli.ufrj.br", appRole: "coordenador" },
  ...
  { name: "Paulo Octavio de Paiva Almeida", title: "Consultor", institution: "AQUAPAR", email: "paulo@aquapar.com.br", appRole: "executor" },
  { name: "Carolina Gonçalves dos Santos", title: "Consultor", institution: "AQUAPAR", email: "carolina@aquapar.com.br", appRole: "executor" },
  { name: "Pedro Igor Dias Lameira", title: "Professor", institution: "UFPA", email: "pedrolameira@ufpa.br", appRole: "executor" },
  { name: "André Mitsuo Kogishi", title: "Pesquisador", institution: "IPT", email: "amkogishi@ipt.br", appRole: "executor" },
  { name: "Hito Braga de Moraes", title: "Professor", institution: "UFPA", email: "hito@ufpa.br", appRole: "executor" },
  { name: "Nelio Moura de Figueiredo", title: "Professor", institution: "UFPA", email: "nelio@ufpa.br", appRole: "executor" },
  { name: "Emmanuel Loureiro", title: "Professor", institution: "UFPA", email: "emannuel@ufpa.br", appRole: "executor" },
  { name: "Luiz Antônio Vaz Pinto", title: "Professor", institution: "UFRJ", email: "vaz@oceanica.ufrj.br", appRole: "executor" },
  { name: "Crístofer Hood Marques", title: "Professor", institution: "UFRJ", email: "cristoferhood@oceanica.ufrj.br", appRole: "executor" },
  { name: "Marcos Pereira", title: "Professor", institution: "UFPE", email: "marcos.pereira2@ufpe.br", appRole: "executor" },
